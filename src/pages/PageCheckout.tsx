...
export const PageCheckout = () => {
	...
	return (
		<>
			{state.userName && (
				<p>{state.userName}, double check your order!</p>
			)}
			<div className="mt-4">
				{state.cartGroupedItems.map((groupedItem) => {
					return (
						<div
							key={groupedItem.book.idCode}
						...
						>
							...
							<p className="text-3xl">
								{groupedItem.amount}x {groupedItem.book.title}
							</p>
						</div>
					);
				})}
